...
const Products = (props) => {
  ...
  const [query, setQuery] = useState("http://localhost:1337/api/products?publicationState=preview");
  const [{ data, isLoading, isError }, doFetch] = useDataApi(
    "http://localhost:1337/api/products?publicationState=preview",
    {
      data: [],
    }
  );
  ...
  return (
    <Container>
      ...
      <Row>
        <form
          onSubmit={(event) => {
            restockProducts(`http://localhost:1337/api/products?publicationState=preview/${query}`);
